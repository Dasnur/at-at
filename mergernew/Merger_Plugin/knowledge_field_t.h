...
class temporal_object_t : public temporal_entity_t {
  ...
  public:
    ...
    virtual string loadLK(std::istream& in, string NameLK, int id);
};
...
class condition_attr_value_const_t : public condition_t {
  ...
  public:
    ...
    virtual void dump(std::ostream& out) const override;
    virtual void load(std::istream& in) override;
    virtual void loadLK(int obj_id, int attr_id, string op, string value);
...
class temporal_interval_t : public temporal_entity_t {
  ...
  public:
    ...
    virtual void dump(std::ostream& out) const override;
    virtual void load(std::istream &in) override;
    virtual void loadLK(string NameLK, int id, int obj_id, int attr_id, string op, string value, int obj_id1,int attr_id1, string op1, string value1);
    virtual string to_xml(const knowledge_field_t& kf) const override;
...
class knowledge_field_t {
  ...
  public:
    ...
    static string get_obj_name(string condition_str);
    static string get_attr_name(string condition_str);
    static string get_value(string condition_str);
    static string get_op(string condition_str);
